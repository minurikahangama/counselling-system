...
// Assume you have retrieved the user ID after login
$email = $_SESSION['email']; // Change this based on your session handling

$sql = "SELECT Score, Mental_Status FROM user WHERE Email = '$email'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container3">
                        <div class="circle">
                          <span id="userMarks"></span>
                    
                          <span id="userMarks"><?php echo $userMarks; ?></span>

               
            </div>
            <div class="rectangle" id="userStage"><?php echo $mentalStatus; ?></div>
